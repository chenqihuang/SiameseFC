...
def generate_image_imdb(vid_root_path):
    '''
    # save image crops to the vid_curated_path
    '''
    num_videos = 0
    anno_str = "Annotations/VID/"
    data_str = "Data/VID/"
    ...
    print imdb_video_train
    json.dump(imdb_video_val, open('imdb_video_val.json', 'w'), indent=2)


if __name__ == "__main__":
    vid_root_path = "/home/esc/Experiment/DataSet/ILSVRC2015"
    generate_image_imdb(vid_root_path)
